...
export const WT_DEFS: Record<'home' | 'recommend' | 'library' | 'inbox', WtStepDef> = {
  ...
  home: {
    ...
    body:            'Active reads, progress, and pace \u2014 all at a glance. Tap any book to update your progress or leave a note.',
    ctaLabel:        'Next \u2192',
    tabIdx:          0,
    cardPos:         'bottom',
  ...
  recommend: {
    ...
    tab:             '/(tabs)/search',
    title:           'Your picks',
    body:            'Personalized recommendations that sharpen the more you log. Tap any card to save, dismiss, or find more like it.',
    ctaLabel:        'Next \u2192',
    tabIdx:          1,
    cardPos:         'bottom',
